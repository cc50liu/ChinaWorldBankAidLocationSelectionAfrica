# call_CI_Conf_cnn_5k_annual.R
# Desc:  Calls Causal Image Confounding over DHS points, using 5 satellite bands,
#        Uses annual observations, annual 5k images, and a shallow 3-layer only neural network
...
if (treat_count < 100) {
  ...
  pre_shuffle_df <- run_df %>% 
    select(dhs_id, country, iso3, ID_adm2,lat, lon, treated, treated_other_funder,
           ...
           election_year, unsc, country_gini, corruption_control,      
