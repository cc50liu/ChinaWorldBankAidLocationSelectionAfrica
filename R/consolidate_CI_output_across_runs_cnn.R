...
#uncomment to test
run_versions <- c("cnn_5k_annual","cnn_5k_3yr")
run_directories <-c("./results/cnn_5k_annual",
                    "./results/cnn_5k_3yr")
run_shortnames <- c("annual","3yr")
group_label_for_filename <- "cnn_annual_3yr"
group_label_for_titles <- "Convolutional Neural Network Model"
