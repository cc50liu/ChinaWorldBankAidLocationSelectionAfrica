...
WriteTfRecord(file = "./data/interim/tfrecords/ExampleRecord.tfrecord",
...
MyImageEmbeddings <- GetImageEmbeddings(
  ...
  file = "./data/interim/tfrecords/ExampleRecord.tfrecord",
...
ImageConfoundingAnalysis <- AnalyzeImageConfounding(
  ...
  conda_env = "", # conda env to activate where a version of tensorflow lives
