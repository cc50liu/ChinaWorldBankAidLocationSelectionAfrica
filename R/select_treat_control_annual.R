...
################################################################################
wb_oda_df <- read.csv("./data/interim/africa_oda_end_impute_median_or3.csv") %>% 
  filter(precision_code %in% c(1,2,3) &  #Exact, near, ADM2
           funder=="WB") 
ch_oda_df <- read.csv("./data/interim/africa_oda_end_impute_median_or3.csv") %>% 
  filter(precision_code %in% c(1,2,3) &  #Exact, near, ADM2
           funder=="CH") 
...
write.csv(dhs_treat_control_long,"./data/interim/dhs_treat_control_annual.csv",row.names=FALSE)
...
# 65 control    530 138728
# 66 control    998 138732
