...
#     
#     input_df %>%
#       filter((round(lat,3)==-17.856 & round(lon,3)==15.394)) %>%
#       select(dhs_id, country, image_file, !!sym(fund_sect_param),
#              !!sym(oda_year_column), lat, lon) %>%
#       rename(t_c=!!sym(fund_sect_param),
#              year=!!sym(oda_year_column)) %>%
#       mutate(lat=round(lat,3),
#              lon=round(lon,3))
#     dhs_id country image_file                               t_c  year   lat   lon
#     <int> <chr>   <chr>                                  <int> <dbl> <dbl> <dbl>
#       1  37049 namibia ./data/dhs_tifs/namibia_2000/00195.tif     0  2007 -17.9  15.4
#     
#     
#     # input_df %>% 
#     #   filter((round(lat,3)==-34.054 & round(lon,3)==18.641) |
#     #          (round(lat,3)==-20.162 & round(lon,3)==28.548)) %>% 
#     #   select(dhs_id, country, image_file, !!sym(fund_sect_param), 
#     #          !!sym(oda_year_column), lat, lon) %>% 
#     #   rename(t_c=!!sym(fund_sect_param),
#     #          year=!!sym(oda_year_column)) %>% 
...
#     #          lon=round(lon,3))
# 
#     # dhs_id country      image_file                                  ch_140 ch_140_min_oda_year
#     # <int> <chr>        <chr>                                        <int>               <dbl>
#     # 1  48825 south_africa ./data/dhs_tifs/south_africa_2016/00738.tif      0                2008
#     # 2  55818 zimbabwe     ./data/dhs_tifs/zimbabwe_1999/00024.tif          1                2012
#     
# 
