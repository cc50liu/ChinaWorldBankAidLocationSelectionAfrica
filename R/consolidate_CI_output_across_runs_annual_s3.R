...
#uncomment to test
run_versions <- c("tfrec_cnn_annual_s3","tfrec_emb_annual_s3")
run_directories <-c("./results/tfrec_cnn_annual_s3",
                    "./results/tfrec_emb_annual_s3")
run_shortnames <- c("cnn","emb")
group_label_for_filename <- "cnn_emb_annual_s3"
group_label_for_titles <- "Annual Obs, y 3yrs post-start"
