...
apptainer exec --nv /mimer/NOBACKUP/groups/globalpoverty1/cindy/images/final_upg_causalimages.sif Rscript /mimer/NOBACKUP/groups/globalpoverty1/cindy/eoml_ch_wb/ChinaWorldBankAidLocationSelectionAfrica/R/call_CI_Conf_tfrec_emb_group_annual.R "$FUNDER_SECTOR" "$RUN_NAME" "$ITERATIONS" "$TIME_APPROACH"
