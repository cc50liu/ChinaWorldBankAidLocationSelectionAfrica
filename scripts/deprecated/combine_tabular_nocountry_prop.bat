...
rem ..\code\slurm\combine_tabular_nocountry_prop.bat scaled . 
...
set "outputFile=%resultsDirectory%\combined_nocountry_%runName%_tabular_treat_prop.pdf"

rem Specify input files 
set "inputFiles="
for %%F in ("%resultsDirectory%\nocountry_*treat_prop.pdf") do (
