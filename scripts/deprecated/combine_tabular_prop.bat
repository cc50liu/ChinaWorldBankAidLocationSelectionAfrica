...
rem ..\..\code\slurm\combine_tabular_prop.bat scaled . 
...
set "outputFile=%resultsDirectory%\combined_%runName%_tabular_treat_prop.pdf"

rem Specify input files 
set "inputFiles="
for %%F in ("%resultsDirectory%\*treat_prop.pdf") do (
