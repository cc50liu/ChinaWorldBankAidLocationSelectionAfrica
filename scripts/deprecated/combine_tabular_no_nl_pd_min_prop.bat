...
rem ..\code\slurm\combine_tabular_no_nl_pd_min_prop.bat scaled . 
...
set "outputFile=%resultsDirectory%\combined_no_nl_pd_min_%runName%_tabular_treat_prop.pdf"

rem Specify input files 
set "inputFiles="
for %%F in ("%resultsDirectory%\no_nl_pd_min_*treat_prop.pdf") do (
