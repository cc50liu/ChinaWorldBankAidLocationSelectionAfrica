...
from gee_exporter_L7_mask import GeeExporter

#DEFAULT_MS_BANDS = ['BLUE', 'GREEN', 'RED', 'NIR', 'SWIR1', 'SWIR2']
DEFAULT_MS_BANDS = ['SR_B1','SR_B2','SR_B3','SR_B4','SR_B5','SR_B7']        
...
def export_images(survey_df: pd.DataFrame,
                  ...
                  scale: int = 30,
                  export_tile_diameter: int = 224,  # image dimensions = 224px * 224px
                  start_year: int = 2000,
                  end_year: int = 2013,
                  span_length: int = 1
                  ):
    ...
    buffer_dist = scale * export_tile_diameter  # scale in m/px * diameter in px = buffer in m
